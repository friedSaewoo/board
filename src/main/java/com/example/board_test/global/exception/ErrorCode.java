...
public enum ErrorCode {
    ...
    // Chess Review
    CHESS_ANALYSIS_DRAFT_NOT_FOUND(HttpStatus.NOT_FOUND, "CHESS_REVIEW_001", "체스 분석 초안을 찾을 수 없습니다."),
    CHESS_ANALYSIS_DRAFT_EXPIRED(HttpStatus.CONFLICT, "CHESS_REVIEW_002", "체스 분석 초안이 만료되었습니다."),
    CHESS_ANALYSIS_DRAFT_CONVERTED(HttpStatus.CONFLICT, "CHESS_REVIEW_003", "이미 리뷰로 생성된 체스 분석 초안입니다."),
    CHESS_REVIEW_NOT_FOUND(HttpStatus.NOT_FOUND, "CHESS_REVIEW_004", "체스 리뷰를 찾을 수 없습니다."),
    CHESS_REVIEW_INVALID_MATCH(HttpStatus.BAD_REQUEST, "CHESS_REVIEW_005", "AI 피드백 매칭 정보가 올바르지 않습니다."),
    CHESS_REVIEW_AI_RESPONSE_REQUIRED(HttpStatus.BAD_REQUEST, "CHESS_REVIEW_006", "AI 응답을 입력해 주세요.");
